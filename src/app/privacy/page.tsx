    ...
    <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-10 py-28">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Camera and Sensor Data</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">Device Information</h3>
            <p className="text-gray-600 mb-4">
